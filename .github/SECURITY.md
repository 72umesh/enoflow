...
EnoFlow is a client-side, in-browser workflow builder. While it does not run server-side workloads, security remains a top priority, particularly regarding client-side code execution in `Code Block` nodes and input sanitization.
